...
These two socities were very important however they were not the only learned socities in the early American republic. In fact there seemed to be an increadible growth in these societies as documented by the earlier observation made by Alexis de Toqueville and in the <i> Scholarly Societies Project </i> at the University of Waterloo Library http://www.scholarly-societies.org/

This data is housed on multiple websites and is difficult to easily scrape but there is much useful data that can be manually entered in a csv file. Since this file has been uploaded with this project it will be easy to collaborate with colleagues to add new socities as they are rediscovered. For example the Agricultural Society of Albemarle was not included in the origninal data of early scholarly socities founded before 1849 in the United States. References to the site and members is found in several sources like in the papers of its first president, and President of the United States, James Madison. 
