...
First, read the data the using the membership lists from societies that had known connections to the national university.
```{r}
...
layout = layout.fruchterman.reingold(full_members$proj2, 
       weights = E(full_members$proj2)$weight),edge.label.cex=1,vertex.shape="circle",edge.color="grey", vertex.size =5, vertex.color="lightblue", asp=0, margin=0,  vertex.label.dist = 1, vertex.label.cex = 1)
